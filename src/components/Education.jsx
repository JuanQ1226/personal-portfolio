      ...
      {myEducation.map((education) => {
        return (
          <Fade className="self-center" direction="up">
            <div className="text-black flex flex-col justify-center items-center bg-neutral-100 border border-neutral-600 rounded-xl md:w-96 p-4 sm:mx-2 md:m-0 mt-4 mb-8">
              <div>
